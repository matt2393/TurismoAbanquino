...
public class XEMERGENCIASFragment extends Fragment {

    private View view;

    ArrayList<LugaresVo> listaEmergencia;
    RecyclerView recyclerViewEmergencia;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view= inflater.inflate(R.layout.fragment_xemergencia, container, false);




        listaEmergencia=new ArrayList<>();
        recyclerViewEmergencia=view.findViewById(R.id.recyclearViewEmergencia);
        recyclerViewEmergencia.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL, false));
        llenarInforamcion();

        AdapterInformacion adaptadorInformacion=new AdapterInformacion(listaEmergencia);
        adaptadorInformacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                switch (recyclerViewEmergencia.getChildAdapterPosition(v)){
        ...
        recyclerViewEmergencia.setAdapter(adaptadorInformacion);
    ...
    private void llenarInforamcion() {
        listaEmergencia.add(new LugaresVo("Emergencias","",R.drawable.ubicacion2));
        listaEmergencia.add(new LugaresVo("Pagina web","Sitio turistico",R.drawable.www1));
        listaEmergencia.add(new LugaresVo("Correo Electronico"," Para mayor informacion",R.drawable.email));
        listaEmergencia.add(new LugaresVo("Instagrama"," Mas detalles",R.drawable.instagrama));
        listaEmergencia.add(new LugaresVo("Telefono"," Para comunicarse",R.drawable.ic_phone_black_24dp));
        listaEmergencia.add(new LugaresVo("WhatsApp"," Obtener informacion",R.drawable.whatsap));
        listaEmergencia.add(new LugaresVo("Facebook"," Para poder refernciarse",R.drawable.faceboook));
        listaEmergencia.add(new LugaresVo("Mesengeer"," Comunicarse",R.drawable.messenger));
